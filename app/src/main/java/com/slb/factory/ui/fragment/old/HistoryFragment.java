package com.slb.factory.ui.fragment.old;
...
import com.slb.factory.ui.activity.old.HistoryDetailActivity;
import com.slb.factory.ui.adapter.old.HisroryChoiseCarNumAdapter;
import com.slb.factory.ui.adapter.old.HisroryChoiseOBDAdapter;
import com.slb.factory.ui.adapter.old.HistoryErrorAdapter;
import com.slb.factory.ui.contract.old.HistoryContract;
import com.slb.factory.ui.presenter.old.HistoryPresenter;
...
public class HistoryFragment
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.TvResetting:
                ...
                if(mOBDAdapter.getData()!=null && mOBDAdapter.getData().size()>0){
                    mOBDAdapter.setItemSel(0);
                    mChoiseObdEntity = (ObdEntity) mOBDAdapter.getItem(0);
                }
                if(mCarNumAdapter.getData()!=null && mCarNumAdapter.getData().size()>0){
                    mCarNumAdapter.setItemSel(0);
                    mChoiseVehicleEntity = (VehicleEntity) mCarNumAdapter.getItem(0);
                }
                break;
            case R.id.TvComfirm:
    ...
    @Subscribe
    public void onRefreshHistoryObdEventEvent(RefreshHistoryObdEvent event) {
        mChoiseObdList = Base.getUserEntity().getObdEntityList();
