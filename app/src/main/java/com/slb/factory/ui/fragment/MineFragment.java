...
import com.slb.factory.ui.activity.old.CarInfoActivity;
import com.slb.factory.ui.activity.old.SettingActivity;
import com.slb.factory.ui.adapter.old.MineCarAdapter;
import com.slb.factory.ui.adapter.old.MineObdAdapter;
...
public class MineFragment
    ...
    @OnClick({R.id.Rl01, R.id.TvSetting,R.id.TvReport})
